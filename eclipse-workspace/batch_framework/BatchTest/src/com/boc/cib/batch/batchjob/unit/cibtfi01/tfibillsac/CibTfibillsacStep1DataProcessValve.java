package com.boc.cib.batch.batchjob.unit.cibtfi01.tfibillsac;
...
public class CibTfibillsacStep1DataProcessValve extends BaseOutputDataProcessValve
{
			...
			throws DataPipeException
	{
		ip_pipeData.setPipeFieldValue("acDate", ip_in.getPipeContext()
				.getParameter("acDate"));
		String loc_cbsAc = ip_pipeData.getPipeFieldStringValue("hldAc");
