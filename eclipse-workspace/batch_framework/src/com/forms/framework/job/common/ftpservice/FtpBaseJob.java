...
public abstract class FtpBaseJob extends BatchBaseJob
{
	...
	protected PatternUtil patternUtil = null;
	...
	public void init() throws BatchJobException
	{
		...
		patternUtil = new PatternUtil(this.batchAcDate);
		super.init();
		InputStream is = null;
		...
		try
		{
			...
			for (Element loc_e : loc_fileList)
			{
				...
				{
					loc_fileParameter.put(StringUtil.xmlToJavaLow(loc_ee.getName()), patternUtil.patternReplace(replaceMap, loc_ee.getText()));
				}
				if (notSendPro != null)
				{
				...
				loc_fileParameter.put("localFileName", loc_localFileName == null ? loc_remoteFileName : loc_localFileName);
				loc_fileParameter.put("remoteFileName", loc_remoteFileName == null ? loc_localFileName : loc_remoteFileName);
				loc_fileParameter.put("backupPath", loc_backupPath == null ? batchBackup : batchBackup + this.separator + patternUtil.patternReplace(replaceMap, loc_backupPath));
				loc_fileParameter.put("backupPattern", loc_backupPattern == null ? DateUtil.BATCH_DATE_FORMAT : loc_backupPattern);
