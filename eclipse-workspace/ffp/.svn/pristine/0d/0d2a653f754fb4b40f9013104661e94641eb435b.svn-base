	...
	<div id="main_layout">
		<div data-options="region:'north',border:false,fit:false"  style="height:82px" >
		    ...
		    <div class="pointMenu" id="pointMenu">
		        <div class="pointStart" title='<spring:message code="system.mainframe.myshortCutMenu" />' >
		        </div>
		        <div class="pointPanel" style="display: none">
		            <div class="point-header">
		                <div class="qieicon"></div>
		                <div class="seticon" title='<spring:message code="system.mainframe.setshortCutMenu" />'  onclick="javascript:void 0" > </div>
		            </div>
		            <ul>
