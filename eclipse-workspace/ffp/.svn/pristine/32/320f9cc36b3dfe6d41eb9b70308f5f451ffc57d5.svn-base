...
public class FFPMsgFfpadr02_Ffpamr01 extends FFPMsgBaseResponseParticipantMessage {

	private FFPVo_Fpsadr02_Ffpamr01REPLY reply = null;
	
	public FFPMsgFfpadr02_Ffpamr01(FFPVo_Fpsadr02_Ffpamr01REPLY reply){
		this.reply = reply;
