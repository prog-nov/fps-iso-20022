 ...
 * Description : 任务规则表单<br>
 * Author : lsc <br>
 * Version : 1.0.0 <br>
 * Since : 1.0.0 <br>
 * Date : 2016-8-23<br>
 */
public class TaskRuleForm extends LogableForm {

    private static final long serialVersionUID = 1500908607483239683L;
     ...
     * 限定机构值(list)
     */
    private List<TaskOrgBean> orgsList;

    /**
     * 是否进操作页面 Y：能进入操作页；N：只出列表页面
     */
    ...
    public List<TaskOrgBean> getOrgsList() {
        return orgsList;
    }

    public void setOrgsList(List<TaskOrgBean> orgsList) {
    ...
    public void setRolesList(List<RoleBean> rolesList) {
