...
public class UserController {
    ...
    @JsonBody
    public int delete(@RequestParam(name = "userId[]") String[] userIds) {
        return service.sDelete(userIds);
    }
    ...
    @JsonBody
    public int updateUserStatus(@RequestParam("userId") String userId, @RequestParam("userStatus") boolean userStatus) {
        return service.sUpdateUserStatus(userId, userStatus);
    }
