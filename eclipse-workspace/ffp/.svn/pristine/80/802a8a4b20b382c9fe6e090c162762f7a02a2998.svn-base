...
<title><spring:message code="system.sysmanager.param.enum.title.enumParamMain" /></title> 
</head>
<body>
			...
			<div class="bf4j-group">
				<div class="bf4j-line">
					<div class="bf4j-cell bf4j-c12 bf4j-right">
						...
						<a class="bf4j-btn-2 gotoUpdateData" title='<spring:message code="system.sysmanager.param.enum.editDetail" />'>
							<i class="bf4j-icon-btn-edit"></i><spring:message code="system.sysmanager.param.enum.editDetail" /></a>
