		...
		return {
			init :  function(){
				...
				grid.datagrid({
					...
					columns : [ [ 
					    ...
					    {field : 'taskId', hidden:true, title : locale.system.sysmanager.taskrule.taskrule.nodeCode},   
						{field : 'taskName', title : locale.system.sysmanager.taskrule.taskrule.nodeName, align:'left', width: 200},
						{field : 'roleFlag', title : locale.system.sysmanager.taskrule.taskrule.LimitedRole, align:'center', width: 200,formatter: me.comboFormatter('BOOLEAN')},
						{field : 'orgFlag', title : locale.system.sysmanager.taskrule.taskrule.QualifiedInstitutions, align:'center', width: 200,formatter: me.comboFormatter('BOOLEAN')},
						{field : 'operFlag', title : locale.system.sysmanager.taskrule.taskrule.QualifiedPerson, align:'center', width: 200,formatter: me.comboFormatter('BOOLEAN')},
						{field : 'detailFlag', title : locale.system.sysmanager.taskrule.taskrule.EnterTheDetails, align:'center', width: 200,formatter: me.comboFormatter('BOOLEAN')}
			        ] ]
				});
			...
			loadUserSubGrid : function(data){
				...
				opergrid.datagrid({
					...
					columns:[[
						...
						{field:'userName', title: locale.system.sysmanager.taskrule.taskrule.username, fit: true, width: 250}
					]]
			...
			loadRoleSubGrid : function (data){
				...
				roleListGrid.datagrid({
					...
					columns:[[
						...
						{field:'roleName', title: locale.system.sysmanager.taskrule.taskrule.roleName, fit: true, width: 250}
					]],
			...
			loadTree : function (container, data){
				...
				tree.treegrid({
					...
					queryParams: params,
					columns:[[
					  {title:locale.system.sysmanager.taskrule.taskrule.organizationID,field:'orgId',hidden:true},
					  {title:locale.system.sysmanager.taskrule.taskrule.organizationID,field:'code',hidden:true},
					  {title:locale.system.sysmanager.taskrule.taskrule.organization+' <span class="treeCheckAll tree-checkbox tree-checkbox0"> </span>', field:'text', width:200,
