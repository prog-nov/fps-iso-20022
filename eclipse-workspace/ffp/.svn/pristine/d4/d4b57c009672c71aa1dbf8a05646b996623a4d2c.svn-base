 ...
 * Date : 2013-10-6<br>
 */
public abstract class Sqlite extends AbstractDialect {

    private static final IDialect instance = new Sqlite() {};// 唯一实例

    /**
     * 构造函数私有化
     */
    private Sqlite() {
        super.setType(DBType.SQLITE);
        super.setDriverClassName("org.sqlite.JDBC");
    }
