 ...
 * Description : 平台运行时异常类<br>
 * Author : LinJisong <br>
 * Version : 1.0.0 <br>
 * Since : 1.0.0 <br>
 * Date : 2016-3-23<br>
 */
final public class Beneform4jRuntimeException extends RuntimeException {
    /**
     * 
     */
    ...
    /* package */ Beneform4jRuntimeException(Beneform4jException exception) {
        this(exception.getProxy());
    }

    /* package */ Beneform4jRuntimeException(Beneform4jExceptionInnerProxy proxy) {
