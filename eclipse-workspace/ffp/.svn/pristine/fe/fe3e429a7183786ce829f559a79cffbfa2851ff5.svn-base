...
/**
 * Common interface that all Spy classes can implement. This is used so that any class that is being
 * spied upon can transmit generic information about itself to the whoever is doing the spying.
 *
 * @author Arthur Blake
 */
public interface Spy {
     ...
     * retrieved from the real underlying jdbc driver. This is useful for debugging and tracking
     * down problems with connection pooling.
     *
