		...
		return {
			init :  function(){
				grid.datagrid({
					...
					columns : [ [ 
						{field : 'roleAllotId', title : locale.system.sysmanager.roleallot.RoleAssignment, checkbox : true},   
						{field : 'roleAllotName', title : locale.system.sysmanager.roleallot.assignmentName, align:'left', width: 200},
						{field : 'des', title : locale.system.sysmanager.roleallot.describe, align:'left', width: 400}
			        ] ]
				});
			...
			gotoAdd : function (){
				dialog.dialog({    
				    title: locale.system.sysmanager.roleallot.rolesAssignments,    
				    height:400,
				    width:800,
				    maximized: true,
				    href : apis.gotoAdd,
			...
			gotoUpdate : function (data){
				dialog.dialog({    
				    title: locale.system.sysmanager.roleallot.ModifyRoles,    
				    height:400,
				    width:800,
				    maximized: true,
				    href : apis.gotoEdit,
			...
			doDelete : function (rows){
				$b.Msg.confirm(locale.system.sysmanager.roleallot.remove1+rows.length+locale.system.sysmanager.roleallot.remove2, function(){
					var roleAllotIds = [];
			...
			deleteCallback : function (rs){
				$b.Msg.alert(locale.system.sysmanager.roleallot.removeS + rs + locale.system.sysmanager.roleallot.removeS2);
				//grid.datagrid('reload');
				me.doQuery();
			},
			...
			loadTree : function (container, data, permType){
				...
				tree.treegrid({
					...
					queryParams: params,
					columns:[[
					  {title:locale.system.sysmanager.roleallot.authorizationID,field:'permId',hidden:true},
					  {title:locale.system.sysmanager.roleallot.menuID,field:'code',hidden:true},
					  {title:locale.system.sysmanager.roleallot.menu+'<span class="treeCheckAll tree-checkbox tree-checkbox0"> </span>', field:'text', width:200,
