		...
		<div class="bf4j-group-content">
			<div class="bf4j-line">
				<div class="bf4j-cell bf4j-sc3">
					<label><spring:message code="system.sysmanager.syslog.login.orgId" /></label>
				</div>
				...
				<div class="bf4j-cell bf4j-sc3">
					<label><spring:message code="system.sysmanager.syslog.login.userId" /></label>
				</div>
				<div class="bf4j-cell bf4j-sc5">
					<span class="bf4j-input"> 
				...
				<div class="bf4j-cell bf4j-sc3">
					<label><spring:message code="system.sysmanager.syslog.login.userName" /></label>
				</div>
				<div class="bf4j-cell bf4j-sc5">
					<span class="bf4j-input">
			...
			<div class="bf4j-line">
					<div class="bf4j-cell bf4j-sc3">
						<label><spring:message code="system.sysmanager.syslog.login.loginDate" /></label>
					</div>
					<div class="bf4j-cell bf4j-sc5">
						<span class="bf4j-input"> 
