			...
			<div class="bf4j-group">
				<div class="bf4j-group-content">
					<div class="bf4j-line">
						...
						<div class="bf4j-cell bf4j-c7">
							<span class="bf4j-input"> 
								<input type="text" name="userId" class="easyui-validatebox" style="width: 90%" 
					...
					<div class="bf4j-line">
						...
						<div class="bf4j-cell bf4j-c7">
							<span class="bf4j-input"> 
								<input type="text" name="centNo" class="easyui-validatebox" style="width: 90%" data-options="required:true"/>
							</span>
						</div>
					</div>
					<div class="bf4j-line">
