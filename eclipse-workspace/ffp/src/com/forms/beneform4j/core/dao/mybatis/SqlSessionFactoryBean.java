...
public class SqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
     ...
     * work on the underlying target {@code DataSource}. If there's nevertheless a
     ...
     *
     * The default {@code SpringManagedTransactionFactory} should be appropriate for all cases: be
     ...
     * any attempt at getting an SqlSession through Spring's MyBatis framework will throw an
     ...
     * MyBatis config file. This is used only as a placeholder name. The default value is
