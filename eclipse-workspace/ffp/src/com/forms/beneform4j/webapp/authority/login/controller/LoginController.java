...
public class LoginController {
    ...
    public ModelAndView logout(@RequestParam(value = "sessionId", required = false) String sessionId, IRequestInfo info) {
        ...
        Object obj = WebUtils.getSession() == null ? null : WebUtils.getSession().getAttribute(LoginConst.SESSION_CHANGE_LOCAL_NO_LOGOUT);
        if(obj != null && (Boolean)obj)
        {
        	WebUtils.getSession().setAttribute(LoginConst.SESSION_CHANGE_LOCAL_NO_LOGOUT, Boolean.FALSE);
        }
        else
        {
