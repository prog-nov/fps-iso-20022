...
public class BatchTransactionCheckFileMover extends BatchBaseJob {
	...
	private FFPMsg_REQ_CHK01 generateReqMessage() throws Exception {
		...
		int daybefore = Integer.parseInt(this.actionElement.element("parameters").elementText("daybefore"));
		String transactionDate = getSpecifiedDayBefore(daybefore);
	...
	// get yesterday date
	private String getSpecifiedDayBefore(int dayBefore) {
