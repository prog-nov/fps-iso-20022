	...
	public static void main(String args[])
	{
		...
		try
		{
			...
			for(int i=0; i<txJb.size(); i++)
			{
				...
				String fileName = "FPSPYCI345201805251200" + FFPStringUtils.lpad(String.valueOf(fileNameSeqNm++), '0', 4) + ".xml";
	...
	private static List<FFPJbP100> preC3TestData()
	{
		...
		for(int i = 1; i<= 17; i++)
		{
			...
			if(i< 5)
			{
				...
				p100.setDebtorAccountNumber("01287500673436");
			}
			else if(i >=5 && i < 8)
			{
				p100.setDebtorName("韦辉");
				p100.setDebtorAccountNumber("01287500673534");
			}
			else if(i >= 8 && i<12)
			{
				p100.setDebtorName("Andy");
				p100.setDebtorAccountNumber("01287500683434");
			}
			else if(i >= 12 && i <15)
			{
				p100.setDebtorName("Elise");
				p100.setDebtorAccountNumber("01287500973434");
			}
			else
			{
