package com.forms.ffp.core.connector.sender;
...
import com.forms.ffp.core.connector.sender.mq.FFPApacheMqSenderAgent;
import com.forms.ffp.core.connector.sender.mq.FFPIbmWebSphereMqSenderAgent;
