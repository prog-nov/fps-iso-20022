...
public class FFPConstantsServiceCode
{
	public final static String FFPAGENT_SERVICECODE_C1 = "C1";
	
	public final static String FFPAGENT_SERVICECODE_C2 = "C2";
	
	public final static String FFPAGENT_SERVICECODE_C3 = "C3";
	
	public final static String FFPAGENT_SERVICECODE_D1 = "D1";
