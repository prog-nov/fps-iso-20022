 ...
 * generated in the com.forms.ffp.adaptor.jaxb.participant.request.ffpddi02 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.forms.ffp.adaptor.jaxb.participant.request.ffpddi02
     * 
     */
