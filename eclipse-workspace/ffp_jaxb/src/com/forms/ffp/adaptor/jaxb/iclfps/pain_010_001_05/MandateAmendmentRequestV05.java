 ...
 *       &lt;sequence>
 *         &lt;element name="GrpHdr" type="{urn:iso:std:iso:20022:tech:xsd:pain.010.001.05}GroupHeader47__1"/>
 *         &lt;element name="UndrlygAmdmntDtls" type="{urn:iso:std:iso:20022:tech:xsd:pain.010.001.05}MandateAmendment5__1" maxOccurs="10000"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class MandateAmendmentRequestV05 {
    ...
    protected List<MandateAmendment51> undrlygAmdmntDtls;
     ...
     * {@link MandateAmendment51 }
     * 
     * 
     */
    public List<MandateAmendment51> getUndrlygAmdmntDtls() {
        if (undrlygAmdmntDtls == null) {
            undrlygAmdmntDtls = new ArrayList<MandateAmendment51>();
        }
