		...
		<div class="bf4j-group" >
			<div class="bf4j-group-content" >
				...
				<div class="bf4j-line">
					...
					<div class="bf4j-cell bf4j-sc5">
						<span class="bf4j-input"> <input type="text"
							class="easyui-numberbox" data-options="min:0"  style="width: 42%" /> - <input type="text"
							class="easyui-numberbox" data-options="min:0"  style="width: 42%" />
						</span>
					</div>
					<div class="bf4j-cell bf4j-sc3">
				...
				<div class="bf4j-line">
					...
					<div class="bf4j-cell bf4j-sc5">
						<span class="bf4j-input"> 
							<input type="checkbox" name="type1"  /><spring:message code="demo.product.datelongone"/>
							<input type="checkbox" name="type1"  /><spring:message code="demo.product.datelongtwo"/>
							<input type="checkbox" name="type1"  /><spring:message code="demo.product.datelongthree"/>
						</span>
					</div>
					<div class="bf4j-cell bf4j-sc3">
					...
					<div class="bf4j-cell bf4j-sc13">
						<span class="bf4j-input"> 
							<input type="radio" name="type2"  /><spring:message code="demo.product.roletypelc"/>
							<input type="radio" name="type2"  /><spring:message code="demo.product.roletypekg"/>
							<input type="radio" name="type2"  /><spring:message code="demo.product.roletypexd"/>
							<input type="radio" name="type2"  /><spring:message code="demo.product.roletypedt"/>
						</span>
					</div>
				</div>
				<div class="bf4j-line">
					...
					<div class="bf4j-cell bf4j-sc5">
						<span class="bf4j-input"> <input type="text"
							class="easyui-datebox" style="width: 85px" /> - <input type="text"
							class="easyui-datebox" style="width: 85px" />
						</span>
					</div>
					<div class="bf4j-cell bf4j-sc3">
				...
				<div class="bf4j-line">
					<div class="bf4j-cell bf4j-c12">
						<div class="bf4j-group-more" >
							<div class="bf4j-group-title">
								<span><spring:message code="demo.title.moresearch"/> </span>
							</div>
							<div class="bf4j-group-content bf4j-noborder"  style="display:none"  >
								<div class="bf4j-line">
									<div class="bf4j-cell bf4j-sc3">
										<label><spring:message code="demo.product.name"/>：</label>
									</div>
