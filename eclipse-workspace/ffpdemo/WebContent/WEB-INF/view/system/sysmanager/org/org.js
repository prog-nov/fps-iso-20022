	...
	Page.create(function($){
		...
		return {
			...
			doDelete : function (node){
				$b.Msg.confirm("您确定要删除所选的<font color='red'> "+node.text+ ( node.attributes && node.attributes.count > 0 ? "及其所有子机构" : "") +" </font>吗？", function(){
			...
			deleteCallback : function (){
				...
				$b.Msg.alert('成功删除<font color="red">' + popupMenu.node.text + '</font>');
			},
			...
			doMove : function(target, source){
				...
				$b.Msg.confirm("您确定要将<font color='red'> "+snode.text+" </font> 拖至<font color='red'> "+tnode.text+" </font> 下吗？", function(){
