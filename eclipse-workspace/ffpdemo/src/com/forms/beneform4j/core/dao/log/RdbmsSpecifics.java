...
class RdbmsSpecifics {
    ...
    /**
     * Format an Object that is being bound to a PreparedStatement parameter, for display. The goal
     * is to reformat the object in a format that can be re-run against the native SQL client of the
    ...
    /**
     * Make sure string is escaped properly so that it will run in a SQL query analyzer tool. At
     * this time all we do is double any single tick marks. Do not call this with a null string or
