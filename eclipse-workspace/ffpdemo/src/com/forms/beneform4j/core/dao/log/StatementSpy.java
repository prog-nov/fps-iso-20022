...
public class StatementSpy implements Statement, Spy {
    ...
    /**
     * Create a StatementSpy that wraps another Statement for the purpose of logging all method
     * calls, sql, exceptions and return values.
     *
     ...
     * @param execTime amount of time that the jdbc driver was chugging on the SQL before it threw
     *        an exception.
     */
    ...
    /**
     * Running one-off statement sql is generally inefficient and a bad idea for various reasons, so
     * give a warning when this is done.
     */
    ...
    /**
     * Tracking of current batch (see addBatch, clearBatch and executeBatch) //todo: should access
     * to this List be synchronized?
     */
