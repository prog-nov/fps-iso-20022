 ...
 * Description : 使用Spring组件的简单国际化信息实现类<br>
 * Author : LinJisong <br>
 * Version : 1.0.0 <br>
 * Since : 1.0.0 <br>
 * Date : 2016-3-31<br>
 */
/* package */ class SpringReloadableResourceBundleMessageSource extends AbstractMessageSource {

    private static final String PROPERTIES_SUFFIX = ".properties";

    private static final String XML_SUFFIX = ".xml";

    private String[] basenames = BaseConfig.getBeneform4jLocaleBasenames();
     ...
     * extension or language codes, but in contrast to {@link ResourceBundleMessageSource} referring
     * to a Spring resource location: e.g. "WEB-INF/messages" for "WEB-INF/messages.properties",
     ...
     * {@code java.util.ResourceBundle}. However, this is often not desirable in an application
     ...
     * first check the last-modified timestamp of the file before actually reloading it; so if files
     * don't change, this interval can be set rather low, as refresh attempts will not actually
     * reload.
     ...
     * <p>
     * Default is "true": This behavior is new as of Spring Framework 4.1, minimizing contention
     ...
     * <p>
     * The default is a DefaultResourceLoader. Will get overridden by the ApplicationContext if
     ...
     * <p>
     * Allows for returning a custom {@link Properties} extension in subclasses. Overriding methods
     * should just instantiate a custom {@link Properties} subclass, with no further initialization
     * or population to be performed at that point.
     * 
