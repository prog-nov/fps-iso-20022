...
public class FFPDateUtils {
	private static final Logger _logger = LoggerFactory.getLogger(FFPDateUtils.class);
	...
	public static final String MSG_COMPL = "COMPL";
	public static final String MSG_FROM_BANK_REQ = "FROM_BANK_REQ";
	public static final String MSG_FROM_BANK_ACK = "FROM_BANK_ACK";
	public static final String MSG_TO_BANK_REQ = "TO_BANK_REQ";
	public static final String MSG_TO_BANK_ACK = "TO_BANK_ACK";
	public static final String MSG_TO_ICL_REQ = "TO_ICL_REQ";
	public static final String MSG_TO_ICL_ACK = "TO_ICL_ACK";
	public static final String MSG_FORM_ICL_REQ = "FROM_ICL_REQ";
	public static final String MSG_FROM_ICL_ACK = "FROM_ICL_ACK";
	// public static final String MSG_TRANS_ID =
	// Tool.STRING.getRandomNumeric(12);
	public static final String MSG_TRANS_ID = "TRANSID";
	public static final String MSG_ID = "MSGID";
	public static final String MSG_END_TO_END_ID = "ENDTOENDID";
	...
	public static String getDateStr(String dateStr, String fromFormat, String toFormat, boolean lenient)
	...
	public static void main(String[] args) throws Exception {
		...
		if (_logger.isDebugEnabled()) {
			_logger.debug("Get dateStr1 in ISO date format = "
					+ getDateStr(dateStr1, "yyyy-MM-dd-HH.mm.ss.SSS000", "yyyy-MM-dd"));
		}
		if (_logger.isDebugEnabled()) {
		...
		System.out.println(
				String.format("Date Time: [%1$s]", new Object[] { getDateStr(getDate(1358446142619L), "yyyy-MM-dd") }));
	}
}
